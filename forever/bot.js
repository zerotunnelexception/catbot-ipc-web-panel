...
const LAUNCH_OPTIONS_GAME = 'firejail --join=%JAILNAME% bash -c \'cd ~/$GAMEPATH && %REPLACE_RUNTIME% LD_PRELOAD=%LD_PRELOAD% DISPLAY=:1 PULSE_SERVER="unix:/tmp/pulse.sock" ./hl2_linux -steam -game tf -silent -sw -w 1 -h 480 -novid -nojoy -noipx -noshaderapi -nomouse -nomessagebox -nominidumps -nohltv -nobreakpad -reuse -noquicktime -precachefontchars -particles 1 -snoforceformat -softparticlesdefaultoff -wavonly -forcenovsync -insecure +clientport 27006-27014\''
